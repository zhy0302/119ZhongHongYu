...
export default class MyFinished extends Component {
    ...
    //             homeworkList
    //         },
    //         HomeworkReducer: homeworkIds
    //     }
    //     } = this.props;
    //     const data = homeworkIds.map(id => {
    //         const {
    //             classInfo,
    //             teacherInfo,
    //             comments: comments_ids
    //         } = homeworkList[id];
    //         const _comments = comments_ids.map(id => comments[id]);
    //         return {
    //             ...homeworkList[id],
    ...
    //         }
    //     })
    //     // console.log('dadadadadadadada',data);
    //     return data;

    // }
    showDiv = () => {
        const { state } = this.props;
        const list = state.MyFinishedReducer;
        let newList;
        if (list) {
